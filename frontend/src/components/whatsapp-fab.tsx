...
export function WhatsAppFab() {
  ...
  const message = "नमस्कार Marda & Sons — I'd like to know more about your collection.";
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3" data-testid="whatsapp-fab-container">
      {open && (
        ...
        >
          ...
          <p className="font-sub text-sm leading-snug">Chat with Marda & Sons on WhatsApp — we usually reply within minutes.</p>
        </div>
      )}
      <a
